...
**Not owned here:** ActionRiskClassifier SPI in casehub-engine-api (casehubio/engine#402 — local placeholder only); oversight channel `allowedTypes` final decision (casehubio/claudony#142).
