...
| [normative-layout-single-source.md](normative-layout-single-source.md) | All channel layout changes must go through OpenClawNormativeLayout — never in individual providers | casehub/ — any code creating or configuring Qhorus channels per case |
